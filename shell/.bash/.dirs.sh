...
alias drive-mount="rclone mount drive: ${DIR_SYNC}/  --attr-timeout 2m --vfs-cache-mode full --vfs-cache-max-age 10m  --dir-cache-time 15m --poll-interval 1m --file-perms 0600 --vfs-write-back 5m --daemon"
