...
(put 'minibuffer-history         'history-length 20)
(put 'file-name-history          'history-length 20)
(put 'set-variable-value-history 'history-length 20)
(put 'custom-variable-history    'history-length 20)
(put 'query-replace-history      'history-length 20)
(put 'read-expression-history    'history-length 20)
(put 'read-char-history          'history-length 20)
(put 'face-name-history          'history-length 20)
(put 'bookmark-history           'history-length 20)
(put 'ivy-history                'history-length 20)
(put 'counsel-M-x-history        'history-length 20)
(put 'counsel-minibuffer-history 'history-length 20)
